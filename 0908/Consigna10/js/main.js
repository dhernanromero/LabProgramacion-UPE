function mostrar_incidencia(){
    var divform = document.getElementById("formularioIncidente")
...
function validar_formulario(){
    ...
    try{
        ...
        var fechaIncidenteInput = document.getElementById("fechaIncidente");
...
function inicio(){
    document.getElementById("registrarIncidencia").addEventListener("click",mostrar_incidencia);
    document.getElementById("formularioIncidente").addEventListener("submit",validar_formulario);
}
